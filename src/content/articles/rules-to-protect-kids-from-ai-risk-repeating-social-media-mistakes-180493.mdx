---
title: "Rules to Protect Kids From AI Risk Repeating Social Media Mistakes"
description: "Policymakers are borrowing from the social media playbook to protect kids from AI chatbots, but experts disagree over whether those rules address the real risks"
date: "2026-08-12"
author: "omar-hassan"
...
Policymakers are borrowing from the social media playbook to protect kids from AI chatbots, but experts disagree over whether those rules address the real risks. This piece looks past the headline to what the shift actually means for developers, security teams, and the people building the next generation of software.
